...
fviz_pca_ind(fmpca.pr, geom = c("point", "text"),
             pointshape = 21, 
             pointsize = 2, 
             fill.ind = ifelse(fmpca$competition=="2019 NSFA 1 Girls Under 16", "16 Girls", "Others"), #paste(fmpca$matchName, fmpca$result), 
             col.ind = "black", 
           #  palette = "Set1", 
             addEllipses = FALSE,
           #  label  = "var",
