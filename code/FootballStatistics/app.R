...
# Load U16s data
FootyGames <- read.csv("FootyGames116.csv", stringsAsFactors = FALSE)
footy_match_play <- read.csv("FootyMatchPlay16.csv", stringsAsFactors = FALSE)
...
our_comp <- "2019 NSFA 1 Girls Under 16"
Dashboard_name <- "U16 Girls"
